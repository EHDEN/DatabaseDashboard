...
```JSON
{ 	"datasources":	[ 
    { "name":example, "folder":"SAMPLE", "cdmVersion": 4 },
    { "name":example, "url":"http://my-sample-server.com/SAMPLE", "cdmVersion": 5 },
    { "name":example,"parentUrl":"http://my-sample-server.com", "url":"SAMPLE" },
    { "name":example, "parentUrl":"http://my-sample-server.com/rest",
	    "map": {
		    "achillesheel" : {
			    "type"	: "service",
				"url"	: "achillesheel/"
